# MODULO DEDICADO A INFORMAÇÕES UTEIS DO PACOTE MATPLOTLIB

#tipos de linhas da função pyplot.grid()
types_line_grid = ['-', '--', '-.', ':', 'None', ' ', '', 'solid', 'dashed', 'dashdot', 'dotted']

#tipos de modelosa de graficos da função pyplot.style.use()
style = ['Solarize_Light2', '_classic_test_patch', '_mpl-gallery', '_mpl-gallery-nogrid',
